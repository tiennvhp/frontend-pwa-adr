...
const allDataFoldersMustWatch = ['./src/app/account/account.component.html', './src/app/help-center/help-center.component.html', './src/app/detail-page/detail-page-mobile.component.html','./src/app/ban-the/ban-the.component.html','./src/app/ban-the-mobile/ban-the-mobile.component.html','./src/app/detail-page/detail-page.component.html','./src/app/error-connection-page-mobile/error-connection-page-mobile.component.html', './src/app/department-page-mobile/department-page-mobile.component.html', './src/app/list-page/list-page.component.html', './src/app/list-page-mobile/list-page-mobile.component.html'] 
/*===============GLOBAL DECLARE=================*/
...
gulp.task('color', () =>  {  
  const colorFileContent = fs.readFileSync(targetFolder + 'cuong-sass/base/colors.scss', 'utf8')
